...
dataset = pd.read_csv("C:\\Users\\91991\\Downloads\\deploy-ml-model-flask-master\\Flavia py files\\data.csv")
ds_path = "C:\\Users\\91991\\Downloads\\deploy-ml-model-flask-master\\Flavia leaves dataset"
...
import cv2
def bg_sub(filename):
    test_img_path = 'C:\\Users\\91991\\Downloads\\deploy-ml-model-flask-master\\mobile captures\\' + filename
...
pickle.dump(common_names[y_pred_mobile[0]],open('iris.pkl','wb'))
